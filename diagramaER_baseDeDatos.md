...
*Diagrama ER inspirado en el diagrama de clases sugerido por el profesor. Versión 2, adición de atributos para las entidades. Sujeto a cambios.*
...
*Observación: (La forma de asientos aún es debatida, puede ser multivaluado, con varias strings o número de asiento, o bien una tabla aparte con asociación a cada bus, y estado por viaje. Actualmente, cada bus tendrá 30 asientos como modo de simulación. Los asientos también tendran que tener alguna clase de relación con el viaje, para resetearlos una vez el bus termine uno.)*
